...
def build_cover(wb):
    ...
    note = ("[안내] 이 엑셀은 HWP→PDF 보고서를 편집 가능한 엑셀로 변환한 자료입니다.\n"
            ...
            "· 주요 실적(재고·간편식사·GET커피·즉석조리)은 「지역부별 주요지표 현황」 7월 3주 마감(07.19) 기준 최신화")
...
def build_s1(wb):
    ...
    r = 3
    r = bullets(ws, r, 7, [
        "가. 재고 목표 : 25년 7월 19,945천원 → 목표 20,942천원(105%) / 26년 7월 3주차(07.19) 20,506천원 (전년비 102.5%)",
        "     ※ 7월 주차별 재고 : 1주(07.05) 20,676 → 2주(07.12) 20,422 → 3주(07.19) 20,506천원  [7월 3주 마감 기준]",
    ])
    r = month_table(
...
def build_s3(wb):
    ...
    r = bullets(ws, r, 7, [
        "2) 목표  [실적은 7월 3주 마감(07.19) 기준 최신화]",
        "  - 발주 : 25년 7월 40.5 → 목표 42.5 (105%) / 26년 7월 3주차(07.19) 39.4 (전년비 101.1%)",
        "  - 일매출 : 25년 7월 96,044원 → 목표 100,846원 (105%) / 26년 7월 3주차(07.19) 94,598원 (전년비 100.5%)",
    ])
...
def build_s4(wb):
    ...
    r = 3
    r = bullets(ws, r, 7, [
        "가. 목표  [실적은 7월 3주 마감(07.19) 기준 최신화]",
        "  - 잔수 : 25년 7월 6.3잔 → 26년 7월 3주차(07.19) 6.9잔 (전년비 120.2%, 목표 9잔·전사 10잔)",
        "  - 일매출 : 25년 7월 4,785원 → 26년 7월 3주차(07.19) 5,751원 (전년비 119.2%, 목표 7,000원)",
    ])
    r = month_table(
...
def build_s5(wb):
    ...
    r += 1
    r = bullets(ws, r, 7, [
        "  ※ 아래 팀별 표는 07.12 기준. 지역부 합계는 7월 3주 마감(07.19)으로 최신화",
        "  - 즉석 후라이드(튀김) 가동률 : 7월 3주차(07.19) 수원 63.9% (전년비 102.8%) / 2권역 66.3% / 전사 68.8%",
        "     · 개선대상점(가동률 20%↓·미가동) 32점(10.7%), 미가동 7점(2.3%), 일매출 14,447원",
        "  - 즉석 고구마 가동률 : 7월 3주차(07.19) 수원 40.4% (전년비 164.9%) / 2권역 50.5% / 전사 49.9%",
        "     · 개선대상점(가동률 20%↓·미가동) 139점(42.6%), 미가동 38점(11.7%), 일매출 2,416원",
    ])
